...
public class ImMessageSqlProvider {
    ...
    public String insertSelective(ImMessage record) {
        ...
        if (record.getImusersinglerelationid() != null) {
            sql.VALUES("imUserSingleRelationId", "#{imusersinglerelationid,jdbcType=BINARY}");
        }
        
        return sql.toString();
    }

    public String selectByExampleWithBLOBs(ImMessageExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getImusersinglerelationid() != null) {
            sql.SET("imUserSingleRelationId = #{record.imusersinglerelationid,jdbcType=BINARY}");
        }
    ...
    public String updateByPrimaryKeySelective(ImMessage record) {
        ...
        if (record.getImusersinglerelationid() != null) {
            sql.SET("imUserSingleRelationId = #{imusersinglerelationid,jdbcType=BINARY}");
        }
