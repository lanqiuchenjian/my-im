...
public interface ImMessageMapper {
    ...
    @Insert({
        "insert into im_message (key, repeat, ",
        "check, status, msg_id, ",
        "action, title, content, ",
        "format, sender, ",
        "receiver, extra, ",
        "timestamp, update_time, ",
        "create_time, imUserSingleRelationId)",
        "values (#{key,jdbcType=VARCHAR}, #{repeat,jdbcType=VARCHAR}, ",
        "#{check,jdbcType=BIT}, #{status,jdbcType=BIT}, #{msgId,jdbcType=INTEGER}, ",
        "#{action,jdbcType=VARCHAR}, #{title,jdbcType=VARCHAR}, #{content,jdbcType=VARCHAR}, ",
        "#{format,jdbcType=VARCHAR}, #{sender,jdbcType=VARCHAR}, ",
        "#{receiver,jdbcType=VARCHAR}, #{extra,jdbcType=VARCHAR}, ",
        "#{timestamp,jdbcType=TIMESTAMP}, #{updateTime,jdbcType=TIMESTAMP}, ",
        "#{createTime,jdbcType=TIMESTAMP}, #{imusersinglerelationid,jdbcType=BINARY})"
    })
    ...
    @SelectProvider(type=ImMessageSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
        ...
        @Result(column="imUserSingleRelationId", property="imusersinglerelationid", jdbcType=JdbcType.BINARY)
    })
    ...
    @Select({
        "select",
        "id, key, repeat, check, status, msg_id, action, title, content, format, sender, ",
        "receiver, extra, timestamp, update_time, create_time, imUserSingleRelationId",
        "from im_message",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @Results({
    ...
    @UpdateProvider(type=ImMessageSqlProvider.class, method="updateByExampleWithBLOBs")
    ...
    @Update({
        ...
        "set key = #{key,jdbcType=VARCHAR},",
          ...
          "imUserSingleRelationId = #{imusersinglerelationid,jdbcType=BINARY}",
        "where id = #{id,jdbcType=BIGINT}"
    })
