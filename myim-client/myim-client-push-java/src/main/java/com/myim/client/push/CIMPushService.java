 ...
 ***************************************************************************************
 */
package com.myim.client.push;

import com.myim.client.CIMCacheManager;
import com.myim.client.connect.impl.NioConnectorManager;
...
public class CIMPushService {
	...
	private final NioConnectorManager manager;
	...
	public CIMPushService() {
		manager = NioConnectorManager.getManager();
	}
