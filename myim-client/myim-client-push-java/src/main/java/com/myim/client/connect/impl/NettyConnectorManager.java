...
public class NettyConnectorManager implements ConnectionStrategy{

	private static NettyConnectorManager manager;
	...
	public synchronized static NettyConnectorManager getManager() {

		if (manager == null) {
			manager = new NettyConnectorManager();
		}
