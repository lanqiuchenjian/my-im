 ...
 ***************************************************************************************
 */
package com.myim.client.connect.impl;
...
import com.myim.client.CIMCacheManager;
import com.myim.client.CIMEventBroadcastReceiver;
import com.myim.client.coder.CIMLogger;
import com.myim.client.coder.ClientMessageDecoder;
import com.myim.client.coder.ClientMessageEncoder;
import com.myim.client.connect.ConnectionStrategy;
import com.myim.client.constant.CIMConstant;
import com.myim.client.model.HeartbeatRequest;
import com.myim.client.model.HeartbeatResponse;
import com.myim.client.model.Intent;
...
public class NioConnectorManager implements ConnectionStrategy{

	private static NioConnectorManager manager;
	...
	public synchronized static NioConnectorManager getManager() {
		
		if (manager == null) {
			manager = new NioConnectorManager();
		}
